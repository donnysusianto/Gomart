        ...
        body: SafeArea(
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: [
                Container(
                  child: Text("Indomaret Botol 600ml"),
                  color: Colors.white,
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        if (placeholder1 < 0)
          ...
          Text('Ordered $placeholder1 Indomaret Botol 600ml'),
        if (placeholder2 < 0)
          Text('Transaction Failed')
        ...
        if (placeholder4 < 0)
          ...
          Text('Ordered $placeholder4 lux Shampoo Pet'),
        if (placeholder5 < 0)
          Text('Transaction Failed')
        else if (placeholder5 > 0)
          Text('Ordered $placeholder5 Baterai ABC AAA'),
      ],
    );
  }
}
