...
class Detailmart2 extends StatelessWidget {
        ...
        body: SafeArea(
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: [
                Container(
                  child: Text("Coca-Cola Botol 600ml"),
                  color: Colors.white,
                  alignment: Alignment.center,
                ),
                Container(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        if (placeholder1 < 0)
          ...
          Text('Ordered $placeholder1 Aqua Botol 600ml'),
        if (placeholder2 < 0)
          Text('Transaction Failed')
        else if (placeholder2 > 0)
          Text('Ordered $placeholder2 Coca-Cola Botol 600ml'),
        if (placeholder3 < 0)
          Text('Transaction Failed')
        else if (placeholder3 > 0)
          Text('Ordered $placeholder3 Masker 10ply'),
        if (placeholder4 < 0)
          Text('Transaction Failed')
        else if (placeholder4 > 0)
          Text('Ordered $placeholder4 Clear Shampoo Pet'),
        if (placeholder5 < 0)
          Text('Transaction Failed')
        else if (placeholder5 > 0)
          Text('Ordered $placeholder5 Bateral ABC AAA'),
      ],
    );
  }
}
