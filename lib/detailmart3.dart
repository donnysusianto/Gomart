...
class Detailmart3 extends StatelessWidget {
        ...
        body: SafeArea(
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: [
                Container(
                  child: Text("Lifebouy Shampoo Pet"),
                  color: Colors.white,
                  alignment: Alignment.center,
                ),
                Container(
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: [
                Container(
                  child: Text("Baterai Energizer AAA"),
                  color: Colors.white,
                  alignment: Alignment.center,
                ),
                Container(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        if (placeholder1 < 0)
          ...
          Text('Ordered $placeholder1 Oasis Botol 600ml'),
        if (placeholder2 < 0)
          Text('Transaction Failed')
        else if (placeholder2 > 0)
          Text('Ordered $placeholder2 Fanta Botol 600ml'),
        if (placeholder3 < 0)
          Text('Transaction Failed')
        else if (placeholder3 > 0)
          Text('Ordered $placeholder3 Lays Bag Large'),
        if (placeholder4 < 0)
          Text('Transaction Failed')
        else if (placeholder4 > 0)
          Text('Ordered $placeholder4 Lifebouy Shampoo Pet'),
        if (placeholder5 < 0)
          Text('Transaction Failed')
        else if (placeholder5 > 0)
          Text('Ordered $placeholder5 Baterai Energizer AAA'),
      ],
    );
  }
}
  ...
  Widget okButton = FlatButton(
    ...
    onPressed: () {
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => Ordergomart()));
    },
  );
