...
class Detailmart5 extends StatelessWidget {
        ...
        body: SafeArea(
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: [
                Container(
                  child: Text("le minerale Botol 600ml"),
                  color: Colors.white,
          ...
          Container(
            ...
            child: GridView.count(
              ...
              children: [
                Container(
                  child: Text("Baterai Duracell AAA"),
                  color: Colors.white,
                  alignment: Alignment.center,
                ),
                Container(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        if (placeholder1 < 0)
          ...
          Text('Ordered $placeholder1 le minerale Botol 600ml'),
        if (placeholder2 < 0)
          Text('Transaction Failed')
        else if (placeholder2 > 0)
          Text('Ordered $placeholder2 Sprite Botol 600ml'),
        if (placeholder3 < 0)
          Text('Transaction Failed')
        else if (placeholder3 > 0)
          Text('Ordered $placeholder3 Chitato bag large'),
        if (placeholder4 < 0)
          Text('Transaction Failed')
        else if (placeholder4 > 0)
          Text('Ordered $placeholder4 dettol sabun pet'),
        if (placeholder5 < 0)
          Text('Transaction Failed')
        else if (placeholder5 > 0)
          Text('Ordered $placeholder5 Baterai Duracell AAA'),
      ],
    );
  }
}
